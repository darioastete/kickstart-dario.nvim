...
return {
  ...
  },
  {
    ...
    event = 'VeryLazy',
    opts = {
      -- snacks.notifier maneja vim.notify, noice solo maneja cmdline/LSP
      notify = { enabled = false },
    },
    dependencies = {
      'MunifTanjim/nui.nvim',
      -- nvim-notify eliminado: reemplazado por snacks.notifier
    },
  },
  -- {
  ...
  },
  {
    ...
    keys = {
      ...
      -- { '<Leader>am', '<Cmd>MultipleCursorsAddMatches<CR>', mode = { 'n', 'x' }, desc = 'Add cursors to cword' },
